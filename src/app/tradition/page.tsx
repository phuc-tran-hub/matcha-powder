    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="body-text mb-4 text-black">
                ...
                aided meditation, powdered tea quickly became integral to their spiritual practices<Citation sources={[8, 11]} />.
              </p>
              ...
              <p className="body-text text-black">
                ...
                it into a highly stylized and artistically nuanced practice that became a cornerstone of Japanese culture<Citation sources={[7, 8, 9]} />.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
      ...
      <section className="section bg-matcha-powder/30">
        <div className="container-custom">
          ...
          >
            <h2 className="heading-2 mb-4 text-white">Chanoyu: The Way of Tea</h2>
            <p className="body-text max-w-3xl mx-auto text-white">
              ...
              core principles of harmony, respect, purity, and tranquility<Citation sources={[7, 8]} />.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="body-text mb-6 text-gray-800">
              ...
              to four hours for a formal gathering<InlineCitation sourceNumber={8} />.
            </p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="mb-6">
              ...
              terroir and centuries of expertise in matcha production, with Uji holding a historical reputation for top-tier quality<Citation sources={[21, 22]} />.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border border-matcha-light p-4 rounded">
                <h4 className="font-bold mb-2">Uji, Kyoto</h4>
                <p className="text-sm text-matcha-light">Known for Japan&apos;s highest-quality ceremonial matcha, with ideal climate conditions and 800+ years of tea cultivation history<InlineCitation sourceNumber={21} />.</p>
              </div>
              <div className="border border-matcha-light p-4 rounded">
                <h4 className="font-bold mb-2">Shizuoka</h4>
                <p className="text-sm text-matcha-light">Japan&apos;s largest tea-producing region, known for consistent quality and significant volume production<InlineCitation sourceNumber={22} />.</p>
              </div>
              <div className="border border-matcha-light p-4 rounded">
                <h4 className="font-bold mb-2">Nishio, Aichi</h4>
                <p className="text-sm text-matcha-light">Renowned for fertile soil rich in nutrients, producing matcha with a distinctive rich flavor profile<InlineCitation sourceNumber={38} />.</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="section bg-cream">
        <div className="container-custom">
          ...
          >
            ...
            <p className="body-text max-w-3xl mx-auto text-gray-500">
              More than just a beverage, matcha is considered a &quot;cultural treasure&quot; in Japan, deeply intertwined with the nation&apos;s identity<Citation sources={[4, 9]} />.
            </p>
          </motion.div>
            ...
            >
              <div>
                ...
                <p className="text-black">
                  ...
                  values are expressed and preserved<InlineCitation sourceNumber={42} />.
                </p>
              </div>
              <div>
                ...
                <p className="text-black">
                  ...
                  sweets like wagashi, as well as modern desserts<InlineCitation sourceNumber={9} />.
                </p>
              </div>
              <div>
                ...
                <p className="text-black">
                  ...
                  shading for ceremonial grade matcha underscores a valuing of quality over quantity<Citation sources={[13, 40]} />.
                </p>
              </div>
            </motion.div>
            <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
            ...
            >
              ...
              <p className="body-text mb-4 text-black">
                ...
                profundity, imperfection, and asymmetry<InlineCitation sourceNumber={14} />. It emphasizes unadorned objects and spaces, celebrating the beauty 
                that time and care impart to materials<Citation sources={[7, 14]} />.
              </p>
              <p className="body-text mb-4 text-gray-800">
              ...
              <p className="body-text text-black">
                ...
                that were previously prized<Citation sources={[7, 8, 14]} />.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="border-l-4 border-matcha-dark pl-4 py-3">
                  ...
                  <p className="text-gray-700">
                    ...
                    the &ldquo;flaws,&rdquo; embodying the wabi-sabi acceptance of an object&apos;s history and impermanence<InlineCitation sourceNumber={42} />.
                  </p>
                </div>
                <div className="border-l-4 border-matcha-dark pl-4 py-3">
                  ...
                  <p className="text-gray-700">
                    ...
                    diligent practice, a profound internal state, and an appreciation for the transient beauty of the natural world<InlineCitation sourceNumber={42} />.
                  </p>
                </div>
                <div className="border-l-4 border-matcha-dark pl-4 py-3">
                  ...
                  <p className="text-gray-700">
                    ...
                    nature as a step towards enlightenment (satori)<InlineCitation sourceNumber={42} />.
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="section bg-matcha-powder/20">
        <div className="container-custom">
          ...
          >
            ...
            <p className="body-text max-w-3xl mx-auto text-gray-500">
              Japanese tea culture possesses a rich and nuanced vocabulary for describing the sensory characteristics of matcha, reflecting centuries of refined appreciation<InlineCitation sourceNumber={40} />.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-gray-700 text-center">
                ...
                which are enhanced by the shading process used in matcha cultivation<InlineCitation sourceNumber={40} />.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 text-center">
                ...
                unpleasant bitterness. Essential for a balanced matcha experience<InlineCitation sourceNumber={40} />.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 text-center">
                ...
                of high-quality matcha and provides a fuller sensory experience<InlineCitation sourceNumber={40} />.
              </p>
            </motion.div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <p className="text-black"><span className="font-medium">Color:</span> Vibrant, lively green indicates freshness and proper shading<InlineCitation sourceNumber={40} /></p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-dark font-bold">•</span>
                    <p className="text-black"><span className="font-medium">Texture:</span> Extremely fine powder, like talcum powder, with no graininess<InlineCitation sourceNumber={40} /></p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-dark font-bold">•</span>
                    <p className="text-black"><span className="font-medium">Aroma:</span> Fresh, inviting fragrance that suggests vitality<InlineCitation sourceNumber={40} /></p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-dark font-bold">•</span>
                    <p className="text-black"><span className="font-medium">Taste:</span> Complex balance of umami, sweetness, and pleasant shibumi<InlineCitation sourceNumber={40} /></p>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-dark font-bold">•</span>
                    <p className="text-black"><span className="font-medium">Origin:</span> Specific regions like Uji, Nishio, and Yame are renowned<Citation sources={[21, 22, 38]} /></p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-dark font-bold">•</span>
                    <p className="text-black"><span className="font-medium">Cultivar:</span> Certain tea plant varieties are preferred for matcha<InlineCitation sourceNumber={40} /></p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-dark font-bold">•</span>
                    <p className="text-black"><span className="font-medium">Harvest Time:</span> First harvest (shincha) leaves are highest quality<InlineCitation sourceNumber={40} /></p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-dark font-bold">•</span>
                    <p className="text-black"><span className="font-medium">Processing:</span> Proper steaming, drying, and stone-grinding techniques<Citation sources={[13, 40]} /></p>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="body-text max-w-3xl mx-auto text-gray-500">
              The relationship between gender and tea practice in Japan has evolved significantly throughout history, reflecting broader societal changes<InlineCitation sourceNumber={41} />.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
              ...
              <div className="bg-neutral-100 p-6 rounded-lg shadow-md">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <p className="text-black">
                      <span className="font-medium">Early Modern Period:</span> Predominantly a male domain within samurai culture, with women often restricted to supporting roles<InlineCitation sourceNumber={41} />
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-medium font-bold">•</span>
                    <p className="text-black">
                      <span className="font-medium">Meiji Restoration (1868):</span> Major tea schools opened study to women, often incorporating it into girls&apos; school curriculum<InlineCitation sourceNumber={41} />
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-medium font-bold">•</span>
                    <p className="text-black">
                      <span className="font-medium">Contemporary Japan:</span> Tea practice at the local level is largely dominated by women, both as teachers and students<InlineCitation sourceNumber={41} />
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-matcha-medium font-bold">•</span>
                    <p className="text-black">
                      <span className="font-medium">Institutional Power:</span> Despite grassroots prevalence, higher echelons of major tea schools often remain controlled by men<InlineCitation sourceNumber={41} />
                    </p>
                  </li>
                </ul>
              </div>
            ...
            >
              ...
              <p className="body-text mb-4 text-black">
                ...
                including gentility, politeness, and artistic skills<InlineCitation sourceNumber={25} />. It serves as a way to embody traditional Japanese ideals of womanhood.
              </p>
              <p className="body-text mb-4 text-gray-800">
                For middle-aged and older women, tea practice often serves as a respected hobby and social activity, providing community 
                connection and cultural engagement outside domestic responsibilities<InlineCitation sourceNumber={41} />.
              </p>
              <p className="body-text text-black">
                Research by scholars like Rebecca Corbett highlights how women utilized chanoyu to gain social and cultural capital, 
                sometimes blurring class distinctions<InlineCitation sourceNumber={25} />. Their contributions have been vital to preserving and evolving the tradition, 
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="body-text max-w-3xl mx-auto text-gray-500">
              The creation of authentic matcha is a labor-intensive process refined over centuries. Unlike other teas, matcha requires specialized cultivation techniques and processing methods that contribute to its unique characteristics and premium status<InlineCitation sourceNumber={40} />.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-black mb-4">
              The labor-intensive nature of traditional matcha production reflects fundamental Japanese cultural values: meticulous attention to detail, respect for craftsmanship, and patience in pursuing perfection<Citation sources={[13, 14]} />. Each step requires specialized knowledge passed down through generations of tea producers.
            </p>
            <p className="text-black">
              When compared to mass-produced teas, the time and care invested in creating authentic matcha explains both its premium price and its esteemed place in Japanese cultural heritage<Citation sources={[13, 15]} />. This traditional process is increasingly under pressure as global demand soars, creating tension between maintaining quality and meeting market expectations<InlineCitation sourceNumber={15} />.
            </p>
          </motion.div>
        </div>
      </section>
